...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[Assert\Length(min: 3, minMessage: 'Username is too short. It should have {{ limit }} characters or more.', max: 12, maxMessage: 'Username is too long. It should have {{ limit }} characters or less.')]
    private $username;
    ...
    #[Assert\NotBlank(message:'Password is not required')]
    #[Assert\Length(min: 8, minMessage: 'Password is too short. It should have {{ limit }} characters or more.', max: 64, maxMessage: 'Password is too long. It should have {{ limit }} characters or less.')]
    private $password;
