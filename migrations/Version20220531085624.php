 ...
 */
final class Version20220531085624 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, role_id, email_confirmation_token, email_confirmed, username, email, password, password_reset_token, password_reset_token_last FROM user');
        $this->addSql('DROP TABLE user');
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, role_id INTEGER NOT NULL, email_confirmation_token VARCHAR(255) DEFAULT NULL, email_confirmed BOOLEAN NOT NULL, username VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(64) NOT NULL, password_reset_token VARCHAR(255) DEFAULT NULL, password_reset_token_last DATETIME DEFAULT NULL, signature CLOB DEFAULT NULL, CONSTRAINT FK_8D93D649D60322AC FOREIGN KEY (role_id) REFERENCES role (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO user (id, role_id, email_confirmation_token, email_confirmed, username, email, password, password_reset_token, password_reset_token_last) SELECT id, role_id, email_confirmation_token, email_confirmed, username, email, password, password_reset_token, password_reset_token_last FROM __temp__user');
